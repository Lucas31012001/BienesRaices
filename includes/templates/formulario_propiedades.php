<fieldset>
    ...
    <?php if($propiedad->imagen){ ?>
        <img src="/bienesraices_inicio/imagenes/<?php echo $propiedad->imagen ?>" id="imagen-small">
    <?php } ?>
...
<fieldset>
    ...
    <select name="propiedad[vendedorId]" id="vendedor">
        <option selected value="">-- Seleccione --</option> <!-- selected value indica que esa opción estará mostrada cuando se carge la página -->
